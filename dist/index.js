...
var MonnifyButton = function (_a) {
    ...
    return (React__default['default'].createElement("button", { className: className, onClick: function () { return initializePayment(onComplete, onClose); } }, text || children));
};
...
var MonnifyProvider = function (_a) {
    ...
    var initializePayment = useMonnifyPayment(others);
    return (React__default['default'].createElement(MonnifyContext.Provider, { value: { initializePayment: initializePayment, onComplete: onComplete, onClose: onClose } }, children));
};

var MonnifyConsumerChild = function (_a) {
    var children = _a.children, ref = _a.ref;
    var _b = React.useContext(MonnifyContext), initializePayment = _b.initializePayment, onComplete = _b.onComplete, onClose = _b.onClose;
...
var MonnifyConsumer = React.forwardRef(function (_a, ref) {
    ...
    return (React__default['default'].createElement(MonnifyProvider, __assign({}, others, { onComplete: onComplete, onClose: onClose }),
